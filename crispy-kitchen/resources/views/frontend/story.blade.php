    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-12 mb-2">
                ...
                <a href="{{Route('frontend.news')}}" class="custom-btn btn btn-dark mt-3">Check out News</a>

                <a href="{{Route('frontend.contact')}}" class="custom-btn btn btn-danger mt-3 ms-3">Say Hi</a>
            </div>
